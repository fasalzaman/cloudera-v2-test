...
sudo wget -t 5 https://raw.githubusercontent.com/fasalzaman/cloudera-v2-test/master/cloudera-director.repo -O /etc/yum.repos.d/cloudera-director.repo >> ${LOG_FILE}
